...
import langgraph4j.ai.ImageCollectionPlanService;
import langgraph4j.model.ImageCollectionPlan;
import langgraph4j.state.ImageResource;
import langgraph4j.state.WorkflowContext;
import langgraph4j.tools.ImageSearchTool;
import langgraph4j.tools.LogoGeneratorTool;
import langgraph4j.tools.MermaidDiagramTool;
import langgraph4j.tools.UndrawIllustrationTool;
import langgraph4j.util.SpringContextUtil;
...
public class ImageCollectorNode {
    ...
    public static AsyncNodeAction<MessagesState<String>> create() {
        return node_async(state -> {
            ...
            stopWatch.stop();
            log.info("图片收集耗时: {}", stopWatch.prettyPrint());
