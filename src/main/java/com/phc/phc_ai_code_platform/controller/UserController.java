...
import com.phc.phc_ai_code_platform.model.dto.user.UserAddRequest;
import com.phc.phc_ai_code_platform.model.dto.user.UserLoginRequest;
import com.phc.phc_ai_code_platform.model.dto.user.UserQueryRequest;
import com.phc.phc_ai_code_platform.model.dto.user.UserUpdateRequest;
...
public class UserController {
     ...
     * 用户注册
     *
     * @param =userRegissterRequest 用户注册请求
     * @return 注册结果
     */
    @PostMapping("register")
    public Long userRegister(@RequestBody com.phc.phc_ai_code_platform.model.dto.user.UserRegisterRequest userRegisterRequest) {
