...
import com.phc.phc_ai_code_platform.model.dto.app.AppAdminUpdateRequest;
import com.phc.phc_ai_code_platform.model.dto.app.AppQueryRequest;
import com.phc.phc_ai_code_platform.model.dto.app.AppUpdateRequest;
...
import com.phc.phc_ai_code_platform.ratelimit.annotation.RateLimit;
import com.phc.phc_ai_code_platform.ratelimit.enums.RateLimitType;
import com.phc.phc_ai_code_platform.service.AppService;
import com.phc.phc_ai_code_platform.service.ProjectDownloadService;
 ...
 *  控制层。
 *
 * @author <a href="https://github.com/">程序员菠萝</a>
 */
@RestController
@RequestMapping("/app")
public class AppController {
    ...
    public BaseResponse<Page<AppVO>> listMyAppByPage(@RequestBody AppQueryRequest appQueryRequest, HttpServletRequest request) {
        ...
        ThrowUtils.throwIf(pageSize > AppConstant.DEFAULT_MAX_PAGE_SIZE, ErrorCode.PARAMS_ERROR);
        
        Page<App> appPage = appService.page(Page.of(appQueryRequest.getPageNum(), pageSize), 
                appService.getQueryWrapper(appQueryRequest));
        
        Page<AppVO> appVOPage = new Page<>(appQueryRequest.getPageNum(), pageSize, appPage.getTotalRow());
